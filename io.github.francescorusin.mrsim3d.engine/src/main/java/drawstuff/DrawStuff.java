...
import drawstuff.internal.DrawStuffApi;
import drawstuff.internal.DrawStuffGL;
...
public class DrawStuff {
    ...
    public static void dsSimulationLoop(
            String[] args, int window_width, int window_height, dsFunctions fn) {
    ...
    public static void dsDrawSphere(final float[] pos, final float[] R, float radius) {
        get().dsDrawSphere(pos, R, radius);
    }

    public static void dsDrawSphere(DVector3C pos, DMatrix3C R, double radius) {
    ...
    public static void dsDrawTriangle(
            final float[] pos,
            final float[] R,
            final float[] v0,
            final float[] v1,
    ...
    public static void dsDrawTriangle(
            DVector3C pos, DMatrix3C R, DVector3C v0, DVector3C v1, DVector3C v2, boolean solid) {
        get().dsDrawTriangle(pos, R, v0, v1, v2, solid);
    }

    public static void dsDrawTriangle(
            DVector3C pos, DMatrix3C rot, float[] v, int i, int j, int k, boolean solid) {
        get().dsDrawTriangle(pos, rot, v, i, j, k, solid);
    }

    public static void dsDrawTriangle(
            DVector3C pos, DMatrix3C rot, float[] v0, float[] v1, float[] v2, boolean solid) {
     ...
     * @param solid set to 0 for wireframe
     */
    public static void dsDrawTriangles(
    ...
    public static void dsDrawCylinder(
            final float[] pos, final float[] R, float length, float radius) {
        get().dsDrawCylinder(pos, R, length, radius);
    }

    public static void dsDrawCylinder(DVector3C pos, DMatrix3C R, double length, double radius) {
    ...
    //		    float length, float radius) {
    public static void dsDrawCapsule(final float[] pos, final float[] R, float length, float radius) {
        get().dsDrawCapsule(pos, R, length, radius);
    }

    public static void dsDrawCapsule(DVector3C pos, DMatrix3C R, double length, double radius) {
    ...
    public static void dsDrawConvex(
            final float[] pos,
            final float[] R,
            float[] _planes,
            int _planecount,
    ...
    //		    final float radius) {
    public static void dsDrawSphere(DVector3C pos, DMatrix3C R, final float radius) {
        get().dsDrawSphere(pos, R, radius);
    }
     ...
     */
    // DS_API
    public static void dsSetSphereQuality(int n) {
        /* default = 1 */
        get().dsSetSphereQuality(n);
    }

    // DS_API
    public static void dsSetCapsuleQuality(int n) {
        /* default = 3 */
        throw new UnsupportedOperationException();
    }
