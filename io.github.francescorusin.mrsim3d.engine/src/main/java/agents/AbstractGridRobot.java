                ...
                for (int z = 0; z < grid[0][0].length; ++z) {
                    if (!Objects.isNull(grid[x][y][z])) {
                        ...
                        if (x >= 1 && y >= 1 && !Objects.isNull(grid[x - 1][y - 1][z])) {
                            ...
                            engine.addRigidJoint(grid[x - 1][y - 1][z].getVertexBody(Voxel.Vertex.V110), grid[x][y][z].getVertexBody(Voxel.Vertex.V000));
                            engine.addRigidJoint(grid[x - 1][y - 1][z].getVertexBody(Voxel.Vertex.V111), grid[x][y][z].getVertexBody(Voxel.Vertex.V001));
                        }
                        if (x >= 1 && z >= 1 && !Objects.isNull(grid[x - 1][y][z - 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x - 1][y][z - 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x - 1][y][z - 1].getVertexBody(Voxel.Vertex.V101), grid[x][y][z].getVertexBody(Voxel.Vertex.V000));
                            engine.addRigidJoint(grid[x - 1][y][z - 1].getVertexBody(Voxel.Vertex.V111), grid[x][y][z].getVertexBody(Voxel.Vertex.V010));
                        }
                        if (y >= 1 && z >= 1 && !Objects.isNull(grid[x][y - 1][z - 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x][y - 1][z - 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x][y - 1][z - 1].getVertexBody(Voxel.Vertex.V011), grid[x][y][z].getVertexBody(Voxel.Vertex.V000));
                            engine.addRigidJoint(grid[x][y - 1][z - 1].getVertexBody(Voxel.Vertex.V111), grid[x][y][z].getVertexBody(Voxel.Vertex.V100));
                        }
                        if (x >= 1 && y >= 1 && z >= 1 && !Objects.isNull(grid[x - 1][y - 1][z - 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x - 1][y - 1][z - 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x - 1][y - 1][z - 1].getVertexBody(Voxel.Vertex.V111), grid[x][y][z].getVertexBody(Voxel.Vertex.V000));
                        }
                        if (x >= 1 && y < grid[0].length - 1 && !Objects.isNull(grid[x - 1][y + 1][z])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x - 1][y + 1][z], grid[x][y][z]));
                            engine.addRigidJoint(grid[x - 1][y + 1][z].getVertexBody(Voxel.Vertex.V100), grid[x][y][z].getVertexBody(Voxel.Vertex.V010));
                            engine.addRigidJoint(grid[x - 1][y + 1][z].getVertexBody(Voxel.Vertex.V101), grid[x][y][z].getVertexBody(Voxel.Vertex.V011));
                        }
                        if (x >= 1 && z < grid[0][0].length - 1 && !Objects.isNull(grid[x - 1][y][z + 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x - 1][y][z + 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x - 1][y][z + 1].getVertexBody(Voxel.Vertex.V100), grid[x][y][z].getVertexBody(Voxel.Vertex.V001));
                            engine.addRigidJoint(grid[x - 1][y][z + 1].getVertexBody(Voxel.Vertex.V110), grid[x][y][z].getVertexBody(Voxel.Vertex.V011));
                        }
                        if (y >= 1 && z < grid[0][0].length - 1 && !Objects.isNull(grid[x][y - 1][z + 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x][y - 1][z + 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x][y - 1][z + 1].getVertexBody(Voxel.Vertex.V010), grid[x][y][z].getVertexBody(Voxel.Vertex.V001));
                            engine.addRigidJoint(grid[x][y - 1][z + 1].getVertexBody(Voxel.Vertex.V110), grid[x][y][z].getVertexBody(Voxel.Vertex.V101));
                        }
                        if (x >= 1 && y >= 1 && z < grid[0][0].length - 1 && !Objects.isNull(grid[x - 1][y - 1][z + 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x - 1][y - 1][z + 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x - 1][y - 1][z + 1].getVertexBody(Voxel.Vertex.V110), grid[x][y][z].getVertexBody(Voxel.Vertex.V001));
                        }
                        if (x >= 1 && y < grid[0].length - 1 && z < grid[0][0].length - 1 && !Objects.isNull(grid[x - 1][y + 1][z + 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x - 1][y + 1][z + 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x - 1][y + 1][z + 1].getVertexBody(Voxel.Vertex.V100), grid[x][y][z].getVertexBody(Voxel.Vertex.V011));
                        }
                        if (x < grid.length - 1 && y < grid[0].length - 1 && z < grid[0][0].length - 1 && !Objects.isNull(grid[x + 1][y + 1][z + 1])) {
                            intraVoxelLocks.add(new UnorderedPair<>(grid[x + 1][y + 1][z + 1], grid[x][y][z]));
                            engine.addRigidJoint(grid[x + 1][y + 1][z + 1].getVertexBody(Voxel.Vertex.V000), grid[x][y][z].getVertexBody(Voxel.Vertex.V111));
                        }
                    }
                }
            }
